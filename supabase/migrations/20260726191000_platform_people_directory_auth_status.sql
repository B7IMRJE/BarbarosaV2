...
create or replace function public.get_platform_people_accounts_v2()
returns table (
    id uuid,
    full_name text,
    email text,
...
revoke all on function public.get_platform_people_accounts_v2() from public;
revoke all on function public.get_platform_people_accounts_v2() from anon;
grant execute on function public.get_platform_people_accounts_v2() to authenticated;
