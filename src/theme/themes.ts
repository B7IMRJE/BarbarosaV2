...
export const homeOSThemes: Record<HomeOSThemeName, HomeOSTheme> = {
    ...
    pastel: {
        ...
        colors: {
            ...
            primary: '#185B6A',
            primaryText: '#FFFFFF',
            secondaryButton: '#DCE9ED',
            secondaryButtonText: '#102A32',
            danger: '#A83232',
            dangerBackground: '#FFF0F0',
            iconBackground: '#D4E5EA',
            progressTrack: '#DCE9ED',
            progressFill: '#5C94A1',
            overlay: '#081C22',
            link: '#0B6F86',
            status: {
    ...
    familySoft: {
        ...
        colors: {
            ...
            primary: '#245C3B',
            primaryText: '#FFFFFF',
            secondaryButton: '#DDE9E1',
            secondaryButtonText: '#13291D',
            danger: '#A83232',
            dangerBackground: '#FFF0F0',
            iconBackground: '#D6E5DB',
            progressTrack: '#DDE9E1',
            progressFill: '#679078',
            overlay: '#0B1911',
            link: '#1D6B40',
            status: {
