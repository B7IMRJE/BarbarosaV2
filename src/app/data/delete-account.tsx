            ...
            <View style={{ width: '100%', maxWidth: 900 }}>
                ...
                >
                    ...
                    <Text style={{ color: theme.colors.mutedText, lineHeight: 22, marginTop: 10 }}>
                        This future action will require server-side account deletion and should permanently remove access to your HomeOS account.
                    </Text>
                    <Text style={{ color: theme.colors.mutedText, lineHeight: 22, marginTop: 10 }}>
                        No account deletion happens on this page yet.
                    </Text>
                </ThemedCard>
